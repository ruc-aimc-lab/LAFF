...
def process(options, collection, input_txt_file):
    ...
    # print("collection: {}, input_txt_file: {}".format(collection, input_txt_file))
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        sys.argv = "txt2xml.py v3c1 " \
                   "/data2/hf/VisualSearch/v3c1/SimilarityIndex/Sea_plus_multi_head_/TV20/runs_pretrain_gcc_old_mean_last_11_12_1_12_seed_2/id.sent.score.txt " \
